...
public class PetplandocuploadTest extends BaseClass {

    @Test
    public void SendUsADocumentOnline() throws InterruptedException {

//Launching Website and Accepting cookies
        driver.get("https://www-test-petplan.allianz.co.uk/existing-customers/upload-a-document/");
        acceptCookies();
...
//Upload Document 1
        ...
        UpldDoc1.sendKeys("C:\\Users\\N53820\\OneDrive - Allianz\\Documents\\Test document for Uploading.docx");

        //Upload Document 2
        WebElement UpldDoc2= scrollUntilVisible(By.xpath("//*[@id='fileUpload2']"));
        UpldDoc2.sendKeys("C:\\Users\\N53820\\OneDrive - Allianz\\Documents\\Test document for Uploading.docx");
//Upload Document 3
        WebElement UpldDoc3= scrollUntilVisible(By.xpath("//*[@id='fileUpload3']"));
        UpldDoc3.sendKeys("C:\\Users\\N53820\\OneDrive - Allianz\\Documents\\Test document for Uploading.docx");
